...
export function Logo({ height = 22 }) {
...
export function LogoMark({ height = 22 }) {
  return (
...
export function LeftRail({ nav, setNav, collapsed, onToggleCollapsed, groups, expandedGroups, onToggleGroup }) {
  const items = [
...
export function TopBar({ onNew, unread = 2, onThemeToggle, theme = 'align-light', sizeMode = 'web', onSizeModeToggle }) {
  return (
